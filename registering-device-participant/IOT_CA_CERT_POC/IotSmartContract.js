...
let Chaincode = class {
  ...
  async initLedger(stub, args) {
    ...
    // await stub.putState('ABCD', Buffer.from(JSON.stringify(vehicleListing)));
     ...
     iotDataFile.y = '4';
     iotDataFile.lat = '1.5';
     iotDataFile.long = '24.5';
     iotDataFile.probe = '0.8';
     iotDataFile.label = 'Test Data';


     let iotDataFile1 = {};
     iotDataFile1.x = '13';
     iotDataFile1.y = '41';
     iotDataFile1.lat = '11.5';
     iotDataFile1.long = '4.5';
     iotDataFile1.probe = '10.8';
     iotDataFile1.label = 'Test Data1';


     await stub.putState('1', Buffer.from(JSON.stringify(iotDataFile)));
    await stub.putState('2', Buffer.from(JSON.stringify(iotDataFile1)));
   ...
   */
  async publishIotData(stub, args) {   //createVehicle
    ...
    await stub.putState(args[0], Buffer.from(JSON.stringify(iotData)));

    // here first parameter will be the key and 2nd parameter will be data (KEY VALUE)
    console.info('============= END : Create Car ===========');
  }



  async updateIotData(stub, args) {   //createVehicle
    console.info('============= START : Create Car ===========');
    if (args.length != 2) {
      throw new Error('Incorrect number of arguments. Expecting 2');
    }
